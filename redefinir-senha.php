...
<title> Redefinir Senha - APADRINHE UM SORRISO </title>
</head>
<body>
        ...
        <div class="sobre-dado-fale">
            <div class="sobre-item-fale-login item-esc-imagem">
                      ...
                      <div class="dist-menu-botao"></div>
                        <form action="">
                <label class="label-form" for="fname">Confirmação de e-mail::</label><br>
                <input type="text" class="form-contact-input form-control" name="email" placeholder="Email" required />  
                <label class="label-form" for="fname">Confirmação de Senha:</label><br>
                <input type="password"class="form-contact-input form-control" name="senha" placeholder="Enter Password" name="psw" required>
                <label class="label-form" for="fname">Digite novamente sua Senha:</label><br>
                <input type="password"class="form-contact-input form-control" name="senha" placeholder="Enter Password" name="psw" required>
                 <input class="button-menu" type="submit" value="ALTERAR">
                        </form>
