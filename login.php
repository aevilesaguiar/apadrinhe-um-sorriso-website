...
<title> Login - APADRINHE UM SORRISO </title>
</head>
<body>
        ...
        <div class="sobre-item-fale-login item-esc-imagem">
                ...
                <ul class="login-utils">
                    ...
                    <li>
                        ...
                        <a href="cadastro-pessoa-juridica.php" class="text2 " >
                            Padrinho Pessoa Jurídica
                        </a>
                    </li>
                    <li>
                       
                        <a href="cadastro-pessoa-fisica.php" class="text2">
                            Padrinho Pessoa Física
                        </a>
                    </li>

                    <li>
                        <a href="cadastro-organizacao.php" class="text2">
                            Organização
                        </a>
                    </li>
                </ul>
