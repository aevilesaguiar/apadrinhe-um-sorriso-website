...
<link rel="stylesheet" type="text/css" href="css/style.css">
 ...
 <title> Confirmação dados Doação- APADRINHE UM SORRISO </title>
</head>
<body>
...
<div class="altura-doar ">
            ...
            <h2>CONFIRMAÇÃO DADOS DOAÇÃO</h2>
        </div>
...
<div class="container">
  <div class="row">
    ...
    <a href="dados-doacao.php"> <button class="button-menu-form" type="submit">VOLTAR</button> </a>
    </div>
    <div class="col">

    <a href="apadrinhamento-concluido.php"> <button class="button-menu-form" type="submit">APROVAR</button> </a>
    </div>
 <div class="dist-bot-button"></div>
