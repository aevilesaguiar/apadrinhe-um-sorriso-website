...
CREATE TABLE `cadastra` (
  ...
  CONSTRAINT `cadastra_ibfk_1` FOREIGN KEY (`fk_id_cadastro`) REFERENCES `perfil` (`id_cadastro`),
  CONSTRAINT `cadastra_ibfk_2` FOREIGN KEY (`fk_rg_crianca`) REFERENCES `dados_crianca` (`rg_crianca`)
